...
public class AudioRecorder {
    ...
    //编码
    private final static int AUDIO_ENCODING = AudioFormat.ENCODING_PCM_32BIT;
    // 缓冲区字节大小
    ...
    private void writeDataTOFile(RecordStreamListener listener) {
        ...
        while (status == Status.STATUS_START) {
            readsize = audioRecord.read(audiodata, 0, bufferSizeInBytes);//从音频输入流中读取数据到audiodata数组中
     ...
     * @param filePaths
     */
    private void mergePCMFilesToWAVFile(final List<String> filePaths, Context context) {
